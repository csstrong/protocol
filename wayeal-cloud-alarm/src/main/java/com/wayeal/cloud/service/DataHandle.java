package com.wayeal.cloud.service;
...
import com.wayeal.cloud.dao.*;
import com.wayeal.cloud.dto.*;
import com.wayeal.cloud.rabbit.RabbitMqSendUtil;
import com.wayeal.cloud.rule.ManageAlarmRule;
import com.wayeal.cloud.utils.AlarmThresholdHelp;
...
public class DataHandle {
    ...
    public void init(String s) {
        try {
            ...
            //send alarm info to mq (queueName:wayeal_cloud_notify)
